...
createASDKLink() {
    ...
    AcDbObjectId linkId;
    pBlockTableRecord->appendAcDbEntity(linkId, pLink);
...
void
createGroup(AcDbObjectIdArray& objIds, const TCHAR* pGroupName)
{
...
runIt()
{
    ...
    // "ASDK_TEST_GROUP"
    //
    createGroup(idArr, L"ASDK_TEST_GROUP");
}
